...
#         inputs['src_inputs'], inputs['src_labels'] = src_inputs.cuda(), src_labels.cuda()
#         inputs['src_inputs_k'], inputs['src_labels_k'] = src_inputs_k.cuda(), src_labels_k.cuda()
#         inputs['src_inputs1'], inputs['src_labels1'] = src_inputs1.cuda(), src_label1.cuda()
        
#         inputs['ul_tgt_inputs'] = ul_tgt_inputs.cuda()
#         inputs['ul_tgt_inputs_k'] = ul_tgt_inputs_k.cuda()
#         inputs['ul_tgt_inputs1'] = ul_tgt_inputs1.cuda()
        
#         inputs['l_tgt_inputs'], inputs['l_tgt_labels'] = l_tgt_inputs.cuda(), l_tgt_labels.cuda()
#         inputs['l_tgt_inputs_k'], inputs['l_tgt_labels_k'] = l_tgt_inputs_k.cuda(), l_tgt_labels_k.cuda()
#         inputs['l_tgt_inputs1'], inputs['l_tgt_labels1'] = l_tgt_inputs1.cuda(), l_tgt_label1.cuda()
