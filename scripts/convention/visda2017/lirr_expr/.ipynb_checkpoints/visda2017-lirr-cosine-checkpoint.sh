...
do
    ...
    do
        ...
        --outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_visda2017_lirr_cosine \
        --logf ${logf_root}${source_domain}_${target_domain}_visda2017_lirr_cosine.txt \
        --batch_size ${2} \
        --nthreads 8 \
        --method lirr \
        --trade_off 1 \
