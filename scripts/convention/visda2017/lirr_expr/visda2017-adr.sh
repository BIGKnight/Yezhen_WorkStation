...
logf_root='/nfs/volume-92-5/wangyezhen_i/Projects/Theoretical_Projects/InstaPBM-V1/output/convention/visda2017/adr/'
...
do
    ...
    do
        ...
        --outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_visda2017_adr \
        --logf ${logf_root}${source_domain}_${target_domain}_visda2017_adr.txt \
        --batch_size ${2} \
        --nthreads 8 \
        --method adr \
        --trade_off 0.1 \
