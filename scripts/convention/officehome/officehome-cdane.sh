...
logf_root='/nfs/volume-92-5/wangyezhen_i/Projects/Theoretical_Projects/InstaPBM-V1/output/convention/officehome/cdan/'
...
do
    ...
    do
        ...
        --outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_officehome_cdane \
        --logf ${logf_root}${source_domain}_${target_domain}_officehome_cdane.txt \
        --batch_size ${2} \
        --nthreads 8 \
        --method cdane \
        --trade_off 1 \
        --logger_file_name officehome_cdane
    done
done