...
do
    ...
    --outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_officehome_lirrv1 \
    --logf ${logf_root}${source_domain}_${target_domain}_officehome_lirrv1.txt \
    --batch_size ${3} \
    --nthreads 8 \
    --method lirrv1 \
    --lambda_adv 0.01 \
    ...
    --logger_file_name officehome_lirrv1
done