...
do
    ...
    --outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_officehome_lirr \
    --logf ${logf_root}${source_domain}_${target_domain}_officehome_lirr.txt \
    --batch_size ${3} \
    --nthreads 8 \
    --method lirr \
    --lambda_adv 0.01 \
