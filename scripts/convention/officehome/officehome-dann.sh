...
logf_root='/nfs/volume-92-5/wangyezhen_i/Projects/Theoretical_Projects/InstaPBM-V1/output/convention/officehome/dann/'
...
do
    ...
    do
        ...
        --outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_officehome_dann \
        --logf ${logf_root}${source_domain}_${target_domain}_officehome_dann.txt \
        --batch_size ${2} \
        --nthreads 8 \
        --method dann \
        --trade_off 1 \
