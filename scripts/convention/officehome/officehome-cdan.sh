...
do
    ...
    --outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_officehome_cdan \
    --logf ${logf_root}${source_domain}_${target_domain}_officehome_cdan.txt \
    --batch_size ${3} \
    --nthreads 8 \
    --method cdan \
    --trade_off 0.1 \
