...
datasets=(${1} ${2})
logf_root='/nfs/volume-92-5/wangyezhen_i/Projects/Theoretical_Projects/InstaPBM-V1/output/convention/citycam/dann/'
...
do
    ...
    --logf ${logf_root}${source_domain}_${target_domain}_citycam_dann.txt \
    --batch_size ${3} \
    --nthreads 8 \
    --method dann \
    --temp 1 \
