...
--outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_domainnet_instapbm2 \
--logf ${logf_root}${source_domain}_${target_domain}_instapbm2.txt \
--batch_size 32 \
--nthreads 8 \
--method instapbm \
--trade_off 0.1 \
