...
logf_root='/nfs/volume-92-5/wangyezhen_i/Projects/Theoretical_Projects/InstaPBM-V1/output/LDS/visda2017/instapbm/'
...
do
    ...
    do
        ...
        then
            ...
            --outf /nfs/volume-92-5/wangyezhen_i/CheckPoints/CLMS/${source_domain}_${target_domain}_visda17_instapbm_LDS \
            --logf ${logf_root}${source_domain}_${target_domain}_instapbm_lds.txt \
            --batch_size 32 \
            --nthreads 8 \
            --method instapbm \
            --trade_off 0.1 \
